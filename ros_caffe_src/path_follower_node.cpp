...
int main(int argc, char **argv) {
    ...
    caffe_res_pub = nh.advertise<ros_caffe::CaffeRes>(CAFFE_PATH_FOLLOW_RES_TOPIC_NAME, 1);
    // const std::string ROOT_SAMPLE = ros::package::getPath("ros_caffe");
    const std::string ROOT_SAMPLE = "/home/fyp/FYP/caffe-master";
    model_path = ROOT_SAMPLE + "/models/fyp_path_follow_170420/deploy.prototxt";
    // model_path = ROOT_SAMPLE + "/data/deploy.prototxt";
    weights_path = ROOT_SAMPLE + "/models/fyp_path_follow_170420/fyp_path_follow_170420_iter_1000.caffemodel";
    // weights_path = ROOT_SAMPLE + "/data/bvlc_reference_caffenet.caffemodel";
    // mean_file = ROOT_SAMPLE + "/data/imagenet_mean.binaryproto";
    mean_file = "/home/fyp/FYP/fyp_ws/data/170420/image_mean.binaryproto";
