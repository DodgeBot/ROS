...
const std::string CAFFE_RES_TOPIC_NAME = "/caffe_pedestrian_avoid_res";
...
int main(int argc, char **argv) {
    ros::init(argc, argv, "pedestrian_avoidance_node");
    ros::NodeHandle nh;
    ...
    model_path = ROOT_SAMPLE + "/models/fyp_pedestrian_avoidance_final_v2/deploy.prototxt";
    // model_path = ROOT_SAMPLE + "/data/deploy.prototxt";
    weights_path = ROOT_SAMPLE + "/models/fyp_pedestrian_avoidance_final_v2/fyp_pedestrian_avoidance_final_v2_iter_10000.caffemodel";
    // weights_path = ROOT_SAMPLE + "/data/bvlc_reference_caffenet.caffemodel";
    // mean_file = ROOT_SAMPLE + "/data/imagenet_mean.binaryproto";
    mean_file = "/home/fyp/FYP/fyp_ws/data/Final_v2/image_mean.binaryproto";
